...
public class LongSubTest extends AbstractTest {
    ...
    private static Stream<Arguments> provideTestData() {
        return Stream.of(
                ...
                Arguments.of(-1, Long.MIN_VALUE, Long.MAX_VALUE),
                Arguments.of(-1, Long.MAX_VALUE, Long.MIN_VALUE),
    ...
    public void longSubTest(long operand1, long operand2, long expectedResult) {
    ...
    public void overflowTest(long operand1, long operand2) {
        assertThrows(ArithmeticException.class, () -> calculator.sub(operand1, operand2));
    }
